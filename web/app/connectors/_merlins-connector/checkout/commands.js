...
export const fetchShippingMethodsEstimate = (inputAddress) => (dispatch, getState) => {
    ...
    if (!isInitialized) {
        // Immediately update the address if necessary
        // Otherwise, if the request resolves after the user has started entering data
        // we might overwrite their changes with an outdated address
