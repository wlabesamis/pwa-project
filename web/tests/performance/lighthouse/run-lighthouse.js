...
/**
 * Runs lighthosue against a config file of URLS
 * Use by `npm run test:lighthouse <environment> <preview>
 * Running `npm run test:lighthouse` without arguments will run it against production and without Mobify Preview
 * The configuration file is locationed in `tests/performance/lighthouse/lighthouse-urls.json`
 */
